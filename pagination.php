...
?>
<a class="page-item" href="?per_page=<?= $item_per_page ?>&page=<?= $first_page ?>&BV_TIEUDE=<?= $BV_TIEUDE ?>"></a>

<a class="page-item" href="?per_page=<?= $item_per_page ?>&page=<?= $next_page ?>&BV_TIEUDE=<?= $BV_TIEUDE ?>"></a>
