    ...
    if ($_FILES["tImg"]["error"] == UPLOAD_ERR_OK) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["tImg"]["tmp_name"], $target_file)) {
                ...
                $sql = "UPDATE tour SET T_TEN='$T_TEN', LT_MA='$LT_MA', T_NGAYKHOIHANH='$T_NGAYKHOIHANH', GT_GIA='$GT_GIA', T_MOTA='$T_MOTA', T_HINHANH='$target_file' WHERE T_MA='$TID'";
        ...
        $sql = "UPDATE tour SET T_TEN='$T_TEN', LT_MA='$LT_MA', T_NGAYKHOIHANH='$T_NGAYKHOIHANH', GT_GIA='$GT_GIA', T_MOTA='$T_MOTA' WHERE T_MA='$TID'";
